...
int main(int argc,char **argv){
  ...
  double s2_scale={{s2_scale}};
  double s3_scale={{s3_scale}};
  double rem_scale={{rem_scale}};

  /// gKl 
  double gkl_awake         = {{gkl_awake}}; //correct1_func(awake_ach_fac ,0.0);
  double gkl_awake_fix     = {{gkl_awake_fix}}; //correct1_func(awake_ach_fac ,0.0);
  ...
  double gkl_TC_awake      = {{gkl_TC_awake}}; //correct1_func(awake_ach_fac ,0.0);
  double gkl_TC_awake_fix  = {{gkl_TC_awake_fix}}; //correct1_func(awake_ach_fac ,0.0);
  ...
  double gkl_RE_awake      = {{gkl_RE_awake}}; //correct1_func(awake_ach_fac ,0.0);
  double gkl_RE_awake_fix  = {{gkl_RE_awake_fix}}; //correct1_func(awake_ach_fac ,0.0);
  ...
  double awake_AMPAd2      ={{awake_AMPAd2}}; //wake_ach_fac;
  double awake_AMPAd2_fix  ={{awake_AMPAd2_fix}}; //wake_ach_fac;
  ...
  double gh_TC_awake       ={{gh_TC_awake}}; //-20.0;
  double gh_TC_s2          ={{gh_TC_s2}}; //2.0;
  double gh_TC_s3          ={{gh_TC_s3}}; //2.0;
  double gh_TC_rem         ={{gh_TC_rem}}; //2.0;

  double awake_GABAd2      ={{awake_GABAd2}}; //0.6; //awake_gaba_fac;
  double awake_GABAd2_fix  ={{awake_GABAd2_fix}}; //0.6; //awake_gaba_fac;
  ...
  double awake_GABA_TC     ={{awake_GABA_TC}}; //awake_gaba_fac;
  double awake_GABA_TC_fix ={{awake_GABA_TC_fix}}; //awake_gaba_fac;
  ...
  double awake_AMPA_TC     ={{awake_AMPA_TC}}; //awake_ach_fac;
  double s2_AMPA_TC        ={{s2_AMPA_TC}}; //s2_ach_fac; 
  double s3_AMPA_TC        ={{s3_AMPA_TC}}; //s3_ach_fac; 
  double rem_AMPA_TC       ={{rem_AMPA_TC}}; //rem_ach_fac; 

  double gk_cx_slow_awake  = {{gk_cx_slow_awake}}; //correct1_func(awake_ach_fac ,1.0);
  double gk_cx_slow_s2     = {{gk_cx_slow_s2}}; //correct1_func(s2_ach_fac    ,1.0);
  double gk_cx_slow_s3     = {{gk_cx_slow_s3}}; //correct1_func(s3_ach_fac    ,1.0);
  double gk_cx_slow_rem    = {{gk_cx_slow_rem}}; //correct1_func(rem_ach_fac   ,1.0);

  double gk_cx_spike_awake = {{gk_cx_spike_awake}}; //correct1_func(awake_ach_fac ,1.0);
  double gk_cx_spike_s2    = {{gk_cx_spike_s2}}; //correct1_func(s2_ach_fac    ,1.0);
  double gk_cx_spike_s3    = {{gk_cx_spike_s3}}; //correct1_func(s3_ach_fac    ,1.0);
  double gk_cx_spike_rem   = {{gk_cx_spike_rem}}; //correct1_func(rem_ach_fac   ,1.0);
