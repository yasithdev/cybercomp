...
class RS:public OtherBase{
 ...
 void init(){ 
   ...
   sigma_e={{RS_sigma_e}};
   sigma_dc={{RS_sigma_dc}};
   beta_e={{RS_beta_e}};
   beta_dc={{RS_beta_dc}};
   Idc = {{RS_Idc}};
   S_CX_DEND = {{RS_S_CX_DEND}};
   xpp=-1+sigma;
   xp=-1+sigma;
   x=-1+sigma;
   y= x - alpha/(1-x);
...
public: 
 ...
 void init(){  
   ...
   mu={{FS1_mu}};
   spike={{FS1_spike}}; 
   alpha={{FS1_alpha}};     //3.87;
   sigma={{FS1_sigma}};
   sigma_e={{FS1_sigma_e}}; //1.0; 
   sigma_dc={{FS1_sigma_dc}}; 
   beta_e={{FS1_beta_e}}; //0.1;
   beta_dc={{FS1_beta_dc}};
   Idc = {{FS1_Idc}}; 
   S_CX_DEND = {{FS1_S_CX_DEND}}; 
   xpp=-1+sigma; 
   xp=-1+sigma;
   x=-1+sigma; 
   y= x - alpha/(1-x); 
...
public:
 ...
 GABA_A(Syn_Info *syn_info):Syn(syn_info)  {
   old_v = {{GABA_A_old_v}};
   E_GABA = {{GABA_A_E_GABA}}; //-75; (-70 is more realistic?)
   R = {{GABA_A_R}}, C = {{GABA_A_C}}, R0 = {{GABA_A_R0}}, R1 = {{GABA_A_R1}};
   Alpha = {{GABA_A_Alpha}}; //0.53; //10.5
   Beta = {{GABA_A_Beta}}; //0.18;  //0.166
   lastrelease = {{GABA_A_lastrelease}};
...
public:
 ...
 GABA_B(Syn_Info *syn_info):Syn(syn_info)  {
   ...
   K3 = {{GABA_B_K3}};
   K4 = {{GABA_B_K4}};
   lastrelease = {{GABA_B_lastrelease}};
   C = {{GABA_B_C}}, r0 = {{GABA_B_r0}}, g0 = {{GABA_B_g0}};
 }
