...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print('\nLoading ImageNet data...') # ImageNet-100
    ## Data loading code
    ...
    for class_idx in range(args.num_classes):
        ...
        class_indices = np.random.choice(class_indices, args.num_samples, replace=False)
        train_indices.extend(class_indices)

    val_indices = filter_by_class(np.array(val_dataset.targets), 0, args.num_classes)
