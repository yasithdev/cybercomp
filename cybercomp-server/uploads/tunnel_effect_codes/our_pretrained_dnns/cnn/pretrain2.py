...
parser.add_argument('-a', '--arch', metavar='ARCH', default='vgg13')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #model = VGG("VGG13", class_num=args.num_classes) # vgg11
    ...
    ### CIFAR-100 Dataset >> With augmentations
    ...
    #train_dataset = datasets.CIFAR100('./data/', train=True, download=False, transform=transforms_cifar100_train)
    #val_dataset = datasets.CIFAR100('./data/', train=False, download=False, transform=transforms_cifar100_test)

    print('\nloading the CIFAR10 data...')
    train_dataset = datasets.CIFAR10('./data/', train=True, download=False, transform=transforms_cifar10_train)
    val_dataset = datasets.CIFAR10('./data/', train=False, download=False, transform=transforms_cifar10_test)

    '''
    print('\nLoading ImageNet-100 data...') # ImageNet-100
    ## Data loading code
