...
def build_transform(is_train, args):
    ...
    if is_train:
        ...
        if not resize_im:
            ...
            # RandomCrop >> only applicable for cifar dataset and 32x32 original images
            transform.transforms[0] = transforms.RandomCrop(
                args.input_size, padding=4) ## omitted by me since dataset is not cifar
            #transform.transforms[0] = transforms.Resize(args.input_size)
        return transform
